      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Pequena animação de entrada no valor total.
            TweenAnimationBuilder<double>(
              tween: Tween(begin: 0, end: 1),
              duration: const Duration(milliseconds: 600),
              builder: (context, valor, child) {
                return Opacity(opacity: valor, child: child);
              },
              child: Text(
            ...
            Center(
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  // Antes: só um AlertDialog. Agora: navega para a
                  // nova tela de confirmação (tela nova #2).
                  Navigator.push(
                    context,
                    MaterialPageRoute(
